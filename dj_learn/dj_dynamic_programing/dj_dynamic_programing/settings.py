"""
Django settings for dj_dynamic_programing project.
...
SECRET_KEY = 's5wbfh&s!0+!6qy6udq@ksl4imt1j-cby&r=$qgfdr-*ruz1^n'
...
ROOT_URLCONF = 'dj_dynamic_programing.urls'
...
WSGI_APPLICATION = 'dj_dynamic_programing.wsgi.application'
